...
public class Carte extends Joueur{
	...
	protected boolean carteProtege = false; // Emp�che la carte d'�tre d�truire
	protected boolean CapaciteSpe = true; // Autorise ou pas la carte � avoir une capacit� sp�ciale

	
	// 0:aucun, 1:nature , 2: chaos , 3: symboles , 4: mystique, 5: humain
	// 0: aucune, 1: jour , 2: n�ant, 3: nuit 4: aube 5: cr�puscule 
	...
	//Creation d'un getter pour r�cuperer l'identifiant
	public int getIdentifiantCarte() {
		return identifiantCarte;
	}

	// Cr�ation d'un setter pour changer l'identifiant
	...
	// Cr�ation d'un setter pour changer les infos de la carte
